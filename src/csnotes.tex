...
{\noindent\Huge\bfseries Notes Collection of \\[0.5\baselineskip] Computer Science}\\[2\baselineskip] % Title
{\large \textit{Computer Science}}\\[4\baselineskip] % Tagline or further description
...
\title{{\zihao{1}Computer Science Notes}}
